...
namespace Client.Models
{
    public class MirEffect
    {
        ...
        public void Draw()
        {
            ...
            if (Blend)
            { 
                if (DrawColour != Color.White)
                {                
                    Library.DrawBlend(DrawFrame, DrawX, DrawY, Color.White, UseOffSet, BlendRate * 1 / 10, ImageType.Image);
                    Library.DrawBlend(DrawFrame, DrawX, DrawY, DrawColour, UseOffSet, BlendRate * 9 / 10, ImageType.Image);
                }
                else
                    Library.DrawBlend(DrawFrame, DrawX, DrawY, DrawColour, UseOffSet, BlendRate, ImageType.Image);
            }
